...
int main() {
	...
	/*	Напишите программу, решающую задачу, соответствующую вашему 
	индивидуальному заданию. Для решения задач необходимо использовать указатели. 
	Для работы с массивами не используйте индексы, необходимо использовать 
	адресную арифметику. 
